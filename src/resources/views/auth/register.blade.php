...
<div class="auth">
    ...
    <div class="auth__container">
        ...
        <form method="POST" action="{{ route('register') }}" novalidate class="auth__form">
            @csrf
            <div class="auth__form-group">
                <label for="name" class="auth__form-label">
                    <span class="auth__icon auth__icon--name"></span>
                </label>
                <input type="text" id="name" name="name" placeholder="Username" required autofocus class="auth__input auth__input--name">
            </div>
            @error('name')
            ...
            <div class="auth__form-group">
                ...
                <input type="email" id="email" name="email" placeholder="Email" required class="auth__input auth__input--email">
            </div>
            @error('email')
                <div class="auth__error">{{ $message }}</div>
            @enderror
